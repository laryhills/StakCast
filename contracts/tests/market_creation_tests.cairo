...
fn test_create_multiple_prediction_markets() {
    ...
    assert(market1_id != market2_id, 'Market IDs should be unique');
...
fn test_create_business_prediction_success() {
    ...
    assert(market.market_id == market_id, 'Market ID should be 1');
    assert(
...
fn test_market_data_integrity() {
    ...
    assert(market.market_id == market_id, 'Market ID 1');
